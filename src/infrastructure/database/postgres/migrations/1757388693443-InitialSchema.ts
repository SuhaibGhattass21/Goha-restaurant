...
export class InitialSchema1757388693443 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."workers_status_enum" AS ENUM('admin', 'cashier', 'chef', 'waiter', 'delivery', 'kitchen', 'steawer', 'kitchen_assistant'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."orders_order_type_enum" AS ENUM('dine-in', 'takeaway', 'delivery', 'cafe'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."orders_status_enum" AS ENUM('completed', 'cancelled', 'active', 'pending'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."cancelled_orders_status_enum" AS ENUM('completed', 'cancelled', 'active', 'pending'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."shifts_shift_type_enum" AS ENUM('morning', 'night'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."shifts_status_enum" AS ENUM('opened', 'closed'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."external_receipts_payment_method_enum" AS ENUM('cash', 'card', 'wallet'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."stock_transactions_type_enum" AS ENUM('in', 'out'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."stock_items_type_enum" AS ENUM('مكونات', 'ادوات', 'خضراوات', 'فاكهة', 'لحم', 'فراخ', 'سمك', 'مشروبات', 'اخري'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."stock_items_status_enum" AS ENUM('available', 'lowstock', 'outofstock'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
        ...
        await queryRunner.query(`DO $$ BEGIN CREATE TYPE "public"."supplier_invoices_status_enum" AS ENUM('paid', 'unpaid', 'partial'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
