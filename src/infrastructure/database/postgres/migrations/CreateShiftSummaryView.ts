...
// export class CreateShiftSummaryView1685457381735 implements MigrationInterface {
...
//                 COALESCE(SUM(CASE WHEN o.order_type != 'cafe' THEN o.total_price ELSE 0 END), 0) AS total_revenue,
//                 COALESCE(SUM(CASE WHEN o.order_type = 'cafe' THEN o.total_price ELSE 0 END), 0) AS cafe_revenue,
...
//                 COALESCE(
//                 COALESCE(SUM(CASE WHEN o.order_type != 'cafe' THEN o.total_price ELSE 0 END), 0)
...
//         await queryRunner.query(`DROP VIEW IF EXISTS shift_summary_view`);
//     }
// }
