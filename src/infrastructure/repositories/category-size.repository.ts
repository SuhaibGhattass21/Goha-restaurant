...
import type { CreateCategorySizeDto, UpdateCategorySizeDto } from "../../application/dtos/category-size.dto"
import { ICategorySizeRepository } from "@domain/repositories/category-size.repository.interface"
