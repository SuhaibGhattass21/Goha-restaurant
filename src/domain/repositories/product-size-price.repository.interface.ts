import type { CreateProductSizePriceDto, UpdateProductSizePriceDto } from "@application/dtos/product-size-price.dto"
...
export interface IProductSizePriceRepository {
  ...
  findAll(page?: number, limit?: number): Promise<{ productSizePrices: ProductSizePrice[]; total: number }>
  findByProduct(
    productId: string,
    page?: number,
    limit?: number,
