...
export class UserUseCases {
    ...
    async updateUser(id: string, userData: Partial<CreateUserDto>): Promise<UserResponseDto | null> {
    ...
    async assignPermissionsToUser(userId: string, permissions: string[]): Promise<UserResponseDto | null> {
