...
import { CategoryExtraController } from '../controllers/category-extra.controller';
import { CategorySizeController } from '../controllers/category-size.controller';
import { CategoryController } from '../controllers/category.controller';
import { ProductSizePriceController } from '../controllers/product-size-price.controller';
import { ProductController } from '../controllers/product.controller';
import { ShiftController } from '../controllers/shift.controller';
import { notFoundHandler, errorHandler } from '../middlewares/error-handler.middleware';
import { CategoryExtraRoutes } from '../routes/category-extra.routes';
import { CategorySizeRoutes } from '../routes/category-size.routes';
import { CategoryRoutes } from '../routes/category.routes';
import { ProductSizePriceRoutes } from '../routes/product-size-price.routes';
...
import { CategoryExtraRepositoryImpl } from '../../../infrastructure/repositories/category-extra.repository';
import { CategoryExtraUseCases } from '../../../application/use-cases/category-extra.use-cases';
import { CategorySizeRepositoryImpl } from '../../../infrastructure/repositories/category-size.repository';
import { CategorySizeUseCases } from '../../../application/use-cases/category-size.use-cases';
import { ProductRepositoryImpl } from '../../../infrastructure/repositories/product.repository.impl';
import { ProductUseCases } from '../../../application/use-cases/product.use-cases';
import { ProductSizePriceRepositoryImpl } from '../../../infrastructure/repositories/product-size-price.repository.impl';
import { ProductSizePriceUseCases } from '../../../application/use-cases/product-size-price.use-cases';
