...
export class Server {
  ...
  private setupRoutes(dependencies: AppDependencies): void {
    ...
    apiV1.use("/categories", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireOwnership(), dependencies.categoryRoutes.getRouter())
    apiV1.use("/category-extras", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireOwnership(), dependencies.categoryExtraRoutes.getRouter())
    apiV1.use("/category-sizes", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireOwnership(), dependencies.categorySizeRoutes.getRouter())
    apiV1.use("/products", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireOwnership(), dependencies.productRoutes.getRouter())
    apiV1.use("/product-size-prices", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireOwnership() ,dependencies.productSizePriceRoutes.getRouter())
    apiV1.use("/shifts", AuthMiddleware.authenticate(), dependencies.shiftRoutes.getRouter())
    apiV1.use("/workers", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireAnyPermission(['OWNER_ACCESS','workers:access']) ,dependencies.workerRoutes.getRouter())
    apiV1.use("/users", AuthMiddleware.authenticate(),dependencies.userRoutes.getRouter())
    apiV1.use("/permissions", AuthMiddleware.authenticate(),dependencies.permissionRoutes.getRouter())
    apiV1.use("/shift-workers", AuthMiddleware.authenticate(), dependencies.shiftWorkerRoutes.getRouter())
    ...
    apiV1.use("/stock-transactions", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireAnyPermission(['OWNER_ACCESS','access:stock']), dependencies.stockTransactionRoutes.getRouter())
    apiV1.use("/stock-reports", AuthMiddleware.authenticate(), AuthorizationMiddleware.requireAnyPermission(['OWNER_ACCESS','access:stock']), dependencies.stockReportRoutes.getRouter())
    apiV1.use("/orders", AuthMiddleware.authenticate(), dependencies.orderRoutes.getRouter())
    apiV1.use("/order-items", AuthMiddleware.authenticate(), dependencies.orderItemRoutes.getRouter())
    apiV1.use("/cancelled-orders", AuthMiddleware.authenticate(),AuthorizationMiddleware.requireAnyPermission(['OWNER_ACCESS','orders:cancelled']), dependencies.cancelledOrderRoutes.getRouter())
    apiV1.use("/external-receipts", AuthMiddleware.authenticate(), dependencies.externalReceiptRoutes.getRouter())
    apiV1.use("/expenses", AuthMiddleware.authenticate(), dependencies.expenseRoutes.getRouter())
