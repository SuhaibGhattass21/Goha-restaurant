...
class OrderRepositoryImpl {
    ...
    async findByCashierId(cashierId, page = 1, limit = 10) {
    ...
    async findByOrderType(orderType, page = 1, limit = 10) {
        const [orders, total] = await this.orderRepository.findAndCount({
    ...
    async getOrdersByShiftTypeAndDate(shiftType, dateStr) {
        const start = (0, date_fns_1.startOfDay)(new Date(dateStr));
        const end = (0, date_fns_1.endOfDay)(new Date(dateStr));
