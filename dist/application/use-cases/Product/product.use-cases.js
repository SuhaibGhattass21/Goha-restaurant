...
class ProductUseCases {
    ...
    async createProduct(productData) {
        ...
        const existingProductPromise = this.productRepository.findByNameAndCategory(productData.name, productData.category_id);
    ...
    mapToResponseDto(product) {
        return {
            ...
            category: product.category
                ...
                : undefined,
            sizePrices: product.sizePrices?.map((sp) => ({
