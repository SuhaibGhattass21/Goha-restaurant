...
exports.OrderItemUseCases = void 0;
class OrderItemUseCases {
    constructor(orderItemRepository, orderItemExtraRepository) {
    ...
    async getAllOrderItems(page = 1, limit = 10) {
...
exports.OrderItemUseCases = OrderItemUseCases;
//# sourceMappingURL=order-item.use-cases.js.map